          ...
          >
            ...
            <div className="bg-primary p-6 text-white flex items-center justify-between shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-black text-lg">রকমারি পণ্য হাড়ি সাপোর্ট</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50/50">
              {chatMessages.length === 0 && (
                <div className="text-center py-10 px-6">
                  <div className="w-16 h-16 bg-emerald-50 text-emerald-800 rounded-3xl flex items-center justify-center mx-auto mb-4">
                    <TrendingUp size={24} />
                  </div>
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    আমি রকমারি পণ্য হাড়ির এআই অ্যাসিস্ট্যান্ট। আমাদের যেকোনো খাঁটি অর্গানিক পণ্য সম্পর্কে প্রশ্ন করতে পারেন।
                  </p>
                </div>
              )}
                  ...
                  >
                    <div className="flex flex-col gap-1 max-w-[85%]">
                      ...
                      >
                          ...
                          <div className="space-y-2 mb-1">
                            <div className={`flex items-center gap-2 p-2 rounded-xl border ${isMe ? 'bg-white/10 border-white/20' : 'bg-gray-50 border-gray-100'}`}>
                              ...
                              <div className="min-w-0">
                                <p className={`text-[10px] font-black uppercase tracking-widest ${isMe ? 'text-white' : 'text-gray-400'}`}>Voice Message</p>
                                <p className={`text-[9px] font-bold ${isMe ? 'text-white/60' : 'text-gray-300'}`}>Play audio to listen</p>
                              </div>
                            </div>
                            <audio 
                              src={msg.audio} 
                        ...
                        {msg.reactions && (Object.values(msg.reactions).some((v: any) => v)) && (
                          <div className={`absolute -bottom-2 ${isMe ? 'right-2' : 'left-2'} flex gap-1 bg-white shadow-xl border border-gray-100 rounded-full px-1.5 py-0.5 scale-75 origin-top z-10`}>
                            ...
                            {msg.reactions.like && <span className="text-blue-500 animate-bounce">👍</span>}
                          </div>
                        )}
                      </div>
