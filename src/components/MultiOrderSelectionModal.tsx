            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 no-scrollbar">
              <div className="bg-red-50 p-3 rounded-xl border border-dashed border-primary/20 mb-4">
                <p className="text-[10px] text-primary text-center font-bold">
                  Order premium trending products together in one package.
                </p>
              </div>
                        ...
                        <div className="mt-auto space-y-1">
                          {cartItem ? (
                            ...
                            <>
                              ...
                              >
                                {p.isComingSoon ? "Pre-Order" : "Order Now"}
                              </button>
                            </>
                          )}
                        </div>
              ...
              <div className="flex justify-between items-center mb-4">
                <div>
                  ...
                  <p className="text-lg font-bold text-primary">
                    ৳
                    {cartItems.reduce(
                      (acc: number, curr: any) => acc + getProductPrice(curr.product, curr.quantity) * curr.quantity,
                      0,
                    )}
                  </p>
                </div>
